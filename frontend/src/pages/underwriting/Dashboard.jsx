...
const UnderwritingDashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      link: "/underwriting/tickets?status=pending",
    ...
    },
    {
      ...
      link: "/underwriting/tickets?status=approved"
    },
    {
      label: "Rejected",
      ...
      link: "/underwriting/tickets?status=rejected"
    },
  ];
    ...
    <OfficerLayout>
      ...
      >
        ...
        <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>
          Manage underwriting support tickets and approvals
        </p>
      </motion.div>
        ...
        {statCards.map((card, index) => (
          <motion.div key={card.label} variants={itemVariants}>
            <Link
              ...
              style={{
                background: `linear-gradient(135deg, ${card.gradient.includes('pink') || card.gradient.includes('rose') ? '#ec4899, #f43f5e' : card.gradient.includes('amber') || card.gradient.includes('orange') ? '#f59e0b, #ea580c' : card.gradient.includes('emerald') || card.gradient.includes('green') ? '#10b981, #059669' : '#f43f5e, #dc2626'})`
              }}
            >
