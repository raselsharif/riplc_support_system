...
const BrandBar = () => {
  ...
  return (
    ...
    >
      {/* Top bar with greeting, weather, clock (light theme) */}
      <div
        className="px-4 md:px-6 py-2.5 flex items-center justify-between text-xs sm:text-sm border-b"
        style={{
      ...
      {/* Main brand bar */}
      <div
        className="px-4 md:px-6 py-3 flex items-center gap-3 justify-between"
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 rounded-lg text-sm font-medium border min-w-[44px]"
            style={{
              backgroundColor: "var(--bg-muted)",
              color: "var(--text-primary)",
              borderColor: "var(--border-default)",
          ...
          <button
            onClick={logout}
            className="px-3 sm:px-4 py-2 rounded-lg text-sm font-semibold transition-colors border border-red-300 dark:border-red-500 bg-red-500 text-white hover:bg-red-600 dark:bg-red-500 dark:text-white dark:hover:bg-red-600 shadow-sm"
          >
            Logout
          </button>
        </div>
