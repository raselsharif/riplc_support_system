  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full text-white text-xl flex items-center justify-center transition-colors"
        >
          ×
        </button>
        ...
        {images.length > 1 && (
          <div className="flex gap-2 mt-3 overflow-x-auto max-w-full px-4 pb-2">
